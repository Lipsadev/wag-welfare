  ...
  const handleRescueSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cloudRes = await fetch(
        `https://api.cloudinary.com/v1_1/dlgow7bhp/image/upload`,
        {
          method: "POST",
          body: imgForm,
        }
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <form className="space-y-4" onSubmit={handleRescueSubmit}>
            <Input
              ...
              onChange={(e) =>
                setRescueData({ ...rescueData, reporterName: e.target.value })
              }
              required
            />
            <Input
        ...
        <DialogContent className="sm:max-w-lg">
          ...
          <form className="space-y-4" onSubmit={handleVolunteerSubmit}>
            ...
            <Input
              type="text"
              placeholder="Place / Location"
              value={volunteerData.place}
              onChange={(e) => setVolunteerData({ ...volunteerData, place: e.target.value })}
              required
            />
            <Input
              type="tel"
            ...
            />
            <Textarea
              placeholder="Availability (Days/Time you can help)"
              value={volunteerData.availability}
              onChange={(e) =>
                setVolunteerData({ ...volunteerData, availability: e.target.value })
              }
            />
            <Button type="submit" className="w-full" disabled={loading}>
